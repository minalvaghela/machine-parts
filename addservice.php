...
$msg="";
if($_POST){
    $s_name=$_POST['ser_name'];
    $s_price=$_POST['ser_price'];

    $q="INSERT INTO `services` (`name`, `price`) VALUES ('$s_name', '$s_price')";
    mysqli_query($conn,$q);

    if ($q) {
        $msg = '<div class="alert alert-success mt-4" role="alert">
                     Your Product Service Added Successfully!!!
                </div>';
    }
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <br>
                                <br>
                                <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC"> Add
                                    Product
                                    Service</h2>
                                <br>
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" name="ser_name"
                                                placeholder="Enter Service Name" required autocomplete="off"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="price" name="ser_price"
