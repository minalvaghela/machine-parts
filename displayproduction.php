            ...
            <div id="content">
                <section class="tables-section">
                    <div class="outer-w3-agile mt-3">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="getidpro.php" data-parsley-validate=""
                                    data-parsley-priority-enable=true data-parsley-required="This value is required">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">PRODUCT</label>
                                    <div class="col-sm-5">
                                        <select name="p1" required data-parsley-trigger="keyup"
                                data-parsley-required-message="Select any product">
                                ...
                                <button type="submit" class="btn btn-primary" style="margin-left: 80%" name="btn">
                                    <b>Add New Production</b>
                                </button>
                        </form>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php
                                $q = mysqli_query($conn, "SELECT * from production order by production_id desc") or die(mysqli_error($conn));
                                ...
                                while ($productrow = mysqli_fetch_array($q)) {
                                    ...
                                    echo "<td>{$productrow['production_id']}</td>";
                                    echo "<td>{$productrow['date']}</td>";
                                    echo "<td>$name</td>";
                                    echo "<td><a href='viewproduction.php?pid={$productrow['production_id']}'> <input type='button' name='view' value='View' class='btn btn-primary' style='margin:2px'></a></td>";
                                    echo "</tr>";
                                    echo "</tr>";
                                }
                                   ?>
