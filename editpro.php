...
$q = mysqli_query($conn, "SELECT * from product where product_id='{$editid}'") or die(mysqli_error($conn));
$qrow = mysqli_fetch_array($q);
{
    $qty=$qrow['QOH'];
    $pim=$qrow['product_image'];
}
$msg = "";
if ($_POST) 
{
    $product_id = mysqli_real_escape_string($conn, $_POST['product_id']);
    $product_name = mysqli_real_escape_string($conne, $_PST['product_name']);
    
    $product_qoh = mysqli_real_escape_string($conn, $_POST['qoh']);
    //$product_services = mysqli_real_escape_string($conn, $_POST['no_of_freeservices']);
    $product_image = "upload/". $_FILES['product_image']['name'];

    $qupdate = mysqli_query($conn, "update product set product_name='{$product_name}',QOH='{$product_qoh}',No_of_freeservices='{$product_service}',product_image='{$product_image}' where product_id='{$product_id}'") or die(mysqli_error($conn));

    if ($qupdate) 
    {
        move_uploaded_file($_FILES['product_image']['tmp_name'],$product_image);
$msg = '<div class="alert alert-success mt-4" role="alert">
Your product editted successfully!!!
        </div>';
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                ...
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    ...
                                    <input type="hidden" class="form-control" id="name"
                                        value="<?php echo $qrow['product_id'] ?>" name="product_id">
                                    <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputPassword3" id="name"
                                                    name="product_name" value="<?php echo $qrow['product_name'] ?>"
                                        ...
                                        <br>
                                        <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Qoh
                                            </label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" id="inputPassword3"
                                                    name="product_image" value="<?php echo $pim?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                ...
                                                <button style="margin-left:2%" type="button"
                                                    onclick="window.location='displayproduct.php'" class="btn btn-info">
                                                    View </button>
                                            </div>
                                        </div>
                                    </form>
