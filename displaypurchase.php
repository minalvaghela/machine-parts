                ...
                <section class="tables-section">
                    <div class="outer-w3-agile mt-3">
                        ...
                        <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">Purchase
                            Information</h2>
                        <table class="table">
                            <form method="POST" enctype="multipart/form-data" name="supp" action="getidsup.php">
                            ...
                            <tbody>
                                ...
                                <?php
                                $q = mysqli_query($conn, "SELECT *from purchase order by purchase_id desc") or die(mysqli_error($conn));
                                ...
                                while ($productrow = mysqli_fetch_array($q)) {
                                    ...
                                    echo "<td>{$productrow['purchase_id']}</td>";
                                    echo "<td>$name</td>";
                                    echo "<td>{$productrow['date']}</td>";
                                    echo "<td><a href='viewpurchase.php?pid={$productrow['purchase_id']}'> <input type='button' name='view' value='View' class='btn btn-primary' style='margin:2px'></a>| 
                                    <a href='displaypurchase.php?delid={$productrow['purchase_id']}]'><input type='button' value='delete' class='btn btn-danger' style='margin:2px'></a>
