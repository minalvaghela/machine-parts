                    ...
                    <div class="outer-w3-agile mt-3">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $q = mysqli_query($conn, "SELECT * from sales_order order by sales_order_id desc") or die(mysqli_error($conn));
                                ...
                                while ($productrow = mysqli_fetch_array($q)) {
                                   ...
                                   echo "<td><a href='displaysale.php?proid=$productrow[sales_order_id]'><input type='button' value='VIEW' class='btn btn-primary' style='margin:2px'></a>
