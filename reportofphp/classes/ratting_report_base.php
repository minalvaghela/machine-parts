...
/**
 * Table class for ratting report
 */
class ratting_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'ratting_report_base';
		$this->TableName = 'ratting report';
		$this->TableType = 'VIEW';
		...
		// user_id
		$this->user_id = new ReportField('ratting_report_base', 'ratting report', 'x_user_id', 'user_id', '`user_id`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->DateFilter = "";
		$this->fields['user_id'] = &$this->user_id;

		// product_name
		$this->product_name = new ReportField('ratting_report_base', 'ratting report', 'x_product_name', 'product_name', '`product_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->product_name->Lookup = new ReportLookup('product_name', 'ratting_report_base', TRUE, 'product_name', ["product_name","","",""], [], [], [], [], [], [], '`product_name` ASC', '');
		$this->product_name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['product_name'] = &$this->product_name;

		// date
		$this->date = new ReportField('ratting_report_base', 'ratting report', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ratting
		$this->ratting = new ReportField('ratting_report_base', 'ratting report', 'x_ratting', 'ratting', '`ratting`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ratting->Sortable = TRUE; // Allow sort
		$this->ratting->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectFloat");
		$this->ratting->DateFilter = "";
		$this->fields['ratting'] = &$this->ratting;
	}
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`ratting report`";
	}
