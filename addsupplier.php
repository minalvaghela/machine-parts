...
$msg = "";
if ($_POST) {
    $query = "SELECT MAX(supplier_id) FROM `supplier`";
    $id = mysqli_query($conn,$query);
    $supid = mysqli_fetch_array($id)[0] + 1;
    $supplier_name = mysqli_real_escape_string($conn, $_POST['sup_name']);
    $supplier_mob = mysqli_real_escape_string($conn, $_POST['sup_mob']);
    $supplier_add = mysqli_real_escape_string($conn, $_POST['sup_add']);
    $q = mysqli_query($conn, "INSERT INTO `supplier` (`supplier_id`, `supplier_name`, `mob`, `address`, `company_company_id`) VALUES ('$supid', '$supplier_name', '$supplier_mob', ' $supplier_add', '1')") or die(mysqli_error($conn));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <br>
                                <br>
                                <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">Supplier
                                </h2>
                                <br>
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    data-parsley-priority-enable=true data-parsley-required="This value is required">
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Supplier Name
                                        </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" name="sup_name"
                                                placeholder="Enter Supplier Name" required autocomplete="off"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="mob" name="sup_mob"
                                                placeholder="Enter Mobile number" required
                                                data-parsley-required-message="Mobile Number is required"
                                                data-parsley-type="number" data-parsley-maxlength="10" min="1"></textarea>

                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Supplier Address
                                        </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="add" name="sup_add"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit" name="submit" class="btn btn-primary"> Add Supplier
                                            </button>
                                            <button style="margin-left:2%" type="reset" class="btn btn-danger">
                                                Reset</button>
                                            <button style="margin-left:2%" type="button"
                                                onclick="window.location='displaysuplier.php'" class="btn btn-info">
                                                View
                                            </button>
                                        </div>
                                    </div>
