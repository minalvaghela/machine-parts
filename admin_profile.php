...
$sql1 ="select * from user_details where user_id='$_SESSION[u_name]'";
                    ...
                    <div class="row">
                        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">Edit User
                                ...
                                Information</h2>
                            <br>
                            <form method="post" enctype="multipart/form-data" data-parsley-validate="" data-parsley-priority-enable=true
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="email_id"
                                            value='<?php echo "$email";?>' id="email" placeholder="Enter Email Id"
