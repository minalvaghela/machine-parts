...
$msg = "";
if ($_POST) {
    $raw_name = mysqli_real_escape_string($conn, $_POST['rawname']);
    $query = "SELECT MAX(raw_material_id) FROM `raw_material`";
    $id = mysqli_query($conn,$query);
    $rawid = mysqli_fetch_array($id)[0] + 1;
    $rawprice=mysqli_real_escape_string($conn, $_POST['rawprice']);
    $rawqoh=mysqli_real_escape_string($conn, $_POST['rawqoh']);
    $suplier=mysqli_real_escape_string($conn, $_POST['suid']);
   
    $q = mysqli_query($conn, "INSERT INTO `raw_material` (`raw_material_id`, `raw_material_name`, `QOH`) VALUES ('$rawid', '$raw_name', '$rawqoh');") or die(mysqli_error($conn));
    $q1 = mysqli_query($conn, "INSERT INTO `raw_material_detail` (`raw_material_raw_material_id`, `supplier_supplier_id`, `price`) VALUES ('$rawid', '$suplier', '$rawprice');") or die(mysqli_error($conn));

    if ($q && $q1) {

        $msg = '<div class="alert alert-success mt-4" role="alert">
                    Your Raw Material Added Successfully!!!
                </div>';
    }
}
?>
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                ...
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" name="rawname"
                                                placeholder="Enter Raw-Material Name" required autocomplete="off"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="price" name="rawprice"
                                                placeholder="Enter Raw-Material Price" required autocomplete="off"
                                                data-parsley-trigger="keyup" 
                                    ...
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Qoh </label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="qoh" name="rawqoh"
                                                placeholder="Enter Raw-Material Qoh" required autocomplete="off"
                                                data-parsley-trigger="keyup"
                                                data-parsley-required-message="Product Qoh is required"
                                                data-parsley-type="number" min="1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="suid" class="form-control" id="sup_id" required=""
                                                data-parsley-required-message="Select any supplier">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <button style="margin-left:2%" type="button"
                                    onclick="window.location = 'displayrawmaterial.php'" class="btn btn-info">
                                    View </button>
                            </div>
                        </div>
                        </form>
