...
{
    $id=$_GET['id'];
    $sql="SELECT email_id FROM user_details where user_id='$id'";
...
if (isset($_POST['submit'])) {
    $ans=$_POST['ans'];
    $to=$_POST['email'];
    //$ans_date=$_POST['ans_date'];
    $q=mysqli_query($conn,"INSERT INTO `inquiry_detail` (`answer`,`inq_ans_date`) VALUES ('$ans')");
    $sql=mysqli_query($conn,"UPDATE `inquiry` SET `inquiry_status`='inititaed' WHERE `inquiry_id` = '$inq_id'");
    //echo $to;
    $subject="Inquiry for Surya Enginnering";
    $msg="Your Answer for inquiry is $ans";
   ...
   if(mail($to,$subject,$msg,$from))
   {
    //echo $ans;
        ...
        Inquiry Answer submitted successfully!!!
   </div>';
   } 
 }
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                ...
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="readonly" class="form-control" id="inputPassword3" name="email"
                                                placeholder="Enter Email" required
                                                data-parsley-required-message="Email is required"
                                                data-parsley-type="email" value="<?php echo $row?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="ans" name="ans"
                                                ...
                                                data-parsley-required-message="Answer is required"></textarea>
