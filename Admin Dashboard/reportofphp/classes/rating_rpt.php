...
/**
 * Page class (rating_rpt)
 */
class rating_rpt extends rating_base
{
	...
	public function __construct()
	{
		...
		// Table object (rating_base)
		if (!isset($GLOBALS["rating_base"])) {
			$GLOBALS["rating_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["rating_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'rating');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fratingrpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fratingrpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fratingrpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fratingrpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if (!$this->Recordset->EOF) {
			...
			$this->Values[2] = $this->product_id->CurrentValue;
