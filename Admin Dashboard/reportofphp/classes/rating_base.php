 ...
 */
class rating_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// user_id
		$this->user_id = new ReportField('rating_base', 'rating', 'x_user_id', 'user_id', '`user_id`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->DateFilter = "";
		$this->fields['user_id'] = &$this->user_id;

		// product_id
		$this->product_id = new ReportField('rating_base', 'rating', 'x_product_id', 'product_id', '`product_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date
		$this->date = new ReportField('rating_base', 'rating', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ratting
		$this->ratting = new ReportField('rating_base', 'rating', 'x_ratting', 'ratting', '`ratting`', 4, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`rating`";
	}
