...
/**
 * Table class for purchase_return_report
 */
class purchase_return_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableName = 'purchase_return_report';
		$this->TableType = 'VIEW';
		...
		// raw_material_name
		$this->raw_material_name = new ReportField('purchase_return_report_base', 'purchase_return_report', 'x_raw_material_name', 'raw_material_name', '`raw_material_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date
		$this->date = new ReportField('purchase_return_report_base', 'purchase_return_report', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// qty
		$this->qty = new ReportField('purchase_return_report_base', 'purchase_return_report', 'x_qty', 'qty', '`qty`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`purchase_return_report`";
	}
