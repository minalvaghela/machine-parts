...
/**
 * Table class for inquiry datewise
 */
class inquiry_datewise_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'inquiry_datewise_base';
		$this->TableName = 'inquiry datewise';
		$this->TableType = 'VIEW';
		...
		// user_id
		$this->user_id = new ReportField('inquiry_datewise_base', 'inquiry datewise', 'x_user_id', 'user_id', '`user_id`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->DateFilter = "";
		$this->fields['user_id'] = &$this->user_id;

		// date
		$this->date = new ReportField('inquiry_datewise_base', 'inquiry datewise', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->date->Lookup = new ReportLookup('date', 'inquiry_datewise_base', TRUE, 'date', ["date","","",""], [], [], [], [], [], [], '`date` ASC', '');
		$this->date->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['date'] = &$this->date;

		// discripation
		$this->discripation = new ReportField('inquiry_datewise_base', 'inquiry datewise', 'x_discripation', 'discripation', '`discripation`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`inquiry datewise`";
	}
