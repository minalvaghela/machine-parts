...
class feedback_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// user_id
		$this->user_id = new ReportField('feedback_report_base', 'feedback report', 'x_user_id', 'user_id', '`user_id`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->DateFilter = "";
		$this->fields['user_id'] = &$this->user_id;

		// product_name
		$this->product_name = new ReportField('feedback_report_base', 'feedback report', 'x_product_name', 'product_name', '`product_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->product_name->Lookup = new ReportLookup('product_name', 'feedback_report_base', TRUE, 'product_name', ["product_name","","",""], [], [], [], [], [], [], '`product_name` ASC', '');
		$this->product_name->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['product_name'] = &$this->product_name;

		// date
		$this->date = new ReportField('feedback_report_base', 'feedback report', 'x_date', 'date', '`date`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discription
		$this->discription = new ReportField('feedback_report_base', 'feedback report', 'x_discription', 'discription', '`discription`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->discription->Sortable = TRUE; // Allow sort
		$this->discription->DateFilter = "";
		$this->fields['discription'] = &$this->discription;
	}
