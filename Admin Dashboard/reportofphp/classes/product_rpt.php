...
class product_rpt extends product_base
{
	...
	public function run()
	{
		...
		$this->product_category_product_category_id->setVisibility();
		$this->No_of_freeservices->setVisibility();
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if ($firstRow) { // Get first row
				...
				$this->FirstRowData["product_category_product_category_id"] = $this->Recordset->fields('product_category_product_category_id');
				$this->FirstRowData["No_of_freeservices"] = $this->Recordset->fields('No_of_freeservices');
				$this->FirstRowData["product_image"] = $this->Recordset->fields('product_image');
		} else { // Get next row
		...
		if (!$this->Recordset->EOF) {
			...
			$this->product_category_product_category_id->setDbValue($this->Recordset->fields('product_category_product_category_id'));
			$this->No_of_freeservices->setDbValue($this->Recordset->fields('No_of_freeservices'));
			$this->product_image->setDbValue($this->Recordset->fields('product_image'));
			...
			$this->Values[4] = $this->QOH->CurrentValue;
			$this->Values[5] = $this->product_category_product_category_id->CurrentValue;
			$this->Values[6] = $this->No_of_freeservices->CurrentValue;
			$this->Values[7] = $this->product_image->CurrentValue;
		} else {
			$this->product_id->setDbValue("");
			$this->product_name->setDbValue("");
			$this->price->setDbValue("");
			$this->QOH->setDbValue("");
			$this->product_category_product_category_id->setDbValue("");
			$this->No_of_freeservices->setDbValue("");
			$this->product_image->setDbValue("");
		}
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_SEARCH) { // Search row
			...
			$this->product_category_product_category_id->HrefValue = "";

			// No_of_freeservices
			$this->No_of_freeservices->HrefValue = "";
			...
			// product_category_product_category_id
			$this->product_category_product_category_id->ViewValue = $this->product_category_product_category_id->CurrentValue;
			$this->product_category_product_category_id->ViewValue = FormatNumber($this->product_category_product_category_id->ViewValue, 0, -2, -2, -2);
			$this->product_category_product_category_id->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// No_of_freeservices
			$this->No_of_freeservices->ViewValue = $this->No_of_freeservices->CurrentValue;
			$this->No_of_freeservices->ViewValue = FormatNumber($this->No_of_freeservices->ViewValue, 0, -2, -2, -2);
			$this->No_of_freeservices->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");

			// product_image
			$this->product_image->ViewValue = $this->product_image->CurrentValue;
			$this->product_image->CellAttrs["class"] = ($this->RecordCount % 2 <> 1 ? "ew-table-alt-row" : "ew-table-row");
		...
		if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
			...
			// product_category_product_category_id
			$currentValue = $this->product_category_product_category_id->CurrentValue;
			$viewValue = &$this->product_category_product_category_id->ViewValue;
			$viewAttrs = &$this->product_category_product_category_id->ViewAttrs;
			$cellAttrs = &$this->product_category_product_category_id->CellAttrs;
			$hrefValue = &$this->product_category_product_category_id->HrefValue;
			$linkAttrs = &$this->product_category_product_category_id->LinkAttrs;
			$this->Cell_Rendered($this->product_category_product_category_id, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// No_of_freeservices
			$currentValue = $this->No_of_freeservices->CurrentValue;
			$viewValue = &$this->No_of_freeservices->ViewValue;
			$viewAttrs = &$this->No_of_freeservices->ViewAttrs;
			$cellAttrs = &$this->No_of_freeservices->CellAttrs;
			$hrefValue = &$this->No_of_freeservices->HrefValue;
			$linkAttrs = &$this->No_of_freeservices->LinkAttrs;
			$this->Cell_Rendered($this->No_of_freeservices, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

			// product_image
			$currentValue = $this->product_image->CurrentValue;
			$viewValue = &$this->product_image->ViewValue;
			$viewAttrs = &$this->product_image->ViewAttrs;
			$cellAttrs = &$this->product_image->CellAttrs;
			$hrefValue = &$this->product_image->HrefValue;
			$linkAttrs = &$this->product_image->LinkAttrs;
			$this->Cell_Rendered($this->product_image, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
		}
	...
	protected function setupFieldCount()
	{
		...
		if ($this->QOH->Visible)
			$this->DetailColumnCount += 1;
		if ($this->product_category_product_category_id->Visible)
			$this->DetailColumnCount += 1;
		if ($this->No_of_freeservices->Visible)
			$this->DetailColumnCount += 1;
		if ($this->product_image->Visible)
			$this->DetailColumnCount += 1;
	}
	...
	protected function getSort()
	{
		...
		if ($resetSort) {
			...
			$this->price->setSort("");
			$this->QOH->setSort("");
			$this->product_category_product_category_id->setSort("");
			$this->No_of_freeservices->setSort("");
