...
<?php
$pid=$_GET['pid'] ;
 $q = mysqli_query($conn, "SELECT *from production where production_id='$pid'") or die(mysqli_error($conn));                               
while ($productrow = mysqli_fetch_array($q)) {
     $id=$productrow['product_product_id'];
      $date=$productrow['date'];
    

     $supname=mysqli_query($conn,"select product_name from product where product_id='$id'");
     $name=mysqli_fetch_row($supname)[0];
}
?>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                   <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">Production
                            Information
                        </h2>
        ...
        //                                 }
                                ?>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Purchase Id:</label>
                                        <div class="col-sm-10">
                                    ...
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">Supplier
                                            Name</label>
                                        <div class="col-sm-10">
                                            <input readonly class="form-control" id="qty" name="qty"
                                                placeholder="Enter Purchase Qty" required autocomplete="off"
                                    ...
                                    <section class="tables-section">
                                        <div class="outer-w3-agile mt-3">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                $q = mysqli_query($conn, "SELECT * from `production_detail` where production_production_id='$pid'") or die(mysqli_error($conn));
                                while ($productrow = mysqli_fetch_array($q)) {
                                    echo "<tr>";
                                    ...
                                    echo "<td>$name</td>";
                                    echo "<td><a href='editproduction.php?editid={$productrow['raw_material_raw_material_id']} & rowid={$productrow['raw_material_raw_material_id']}'><input type='button' name='edit' value='Edit' class='btn btn-primary' style='margin:2px'></a></td>";
                                    echo "</tr>";
                                }
                                ?>
                                                </tbody>
                            ...
                            <br>
                            <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC"> Insert
                                Production </h2>
                            <form action="_handle_view_production.php" method="POST" enctype="multipart/form-data"
