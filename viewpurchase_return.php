...
<?php
$pid=$_GET['pid'] ;
 $q = mysqli_query($conn, "SELECT *from purchase_return where purchasereturn_id='$pid'") or die(mysqli_error($conn));                               
   while ($productrow = mysqli_fetch_array($q)) {
     $id=$productrow['purchase_purchase_id'];
    ...
    <section class="home-section">
        ...
        //                                 }
                                ?>
                                         <?php
             /* $msg="";
                                if (isset($_GET['delid']) && isset($_get['rowid'])) {
                                    $deleteid = $_GET['delid'];
                                    $rawid=$_GET['rowid'];
                                    $q = mysqli_query($conn, "delete from purchase_return_detail where purchase_return_purchasereturn_id= '$deleteid' and raw_material_raw_material_id='$rawid'") or die(mysqli_error($conn));
                                    
                                   // $q = mysqli_query($conn, "delete from purchase_return where purchasereturn_id = '{$deleteid}'") or die(mysqli_error($conn));
                                    if ($q)
                                     {
                        ...
                        ?>
                                ...
                                <section class="tables-section">
                                    <div class="outer-w3-agile mt-3">
                                        ...
                                        <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">
                                            PurchaseReturn information
                                        </h2>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">PurchaseReturn Id:</label>
                                            <div class="col-sm-10">
                                                <input readonly class="form-control" id="qty" name="qty"
                                                    ...
                                                    data-parsley-type="number" value="<?php echo $pid?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="form-group row">
                                            <label for="inputPassword3"
                                                class="col-sm-2 col-form-label">PurchaseId</label>
                                            <div class="col-sm-10">
                                                <input readonly class="form-control" id="qty" name="qty"
                                                    placeholder="Enter Purchase Qty" required autocomplete="off"
                                                    data-parsley-trigger="keyup"
                                            ...
                                            <section class="tables-section">
                                                <div class="outer-w3-agile mt-3">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                $q = mysqli_query($conn, "SELECT * from `purchase_return_detail` where purchase_return_purchasereturn_id='$pid'") or die(mysqli_error($conn));
                                while ($productrow = mysqli_fetch_array($q)) {
                                    echo "<tr>";
                                    ...
                                    echo "<td>$name</td>";
                                   echo "<td><a href='editpurchase_return.php?editid={$productrow['purchase_return_purchasereturn_id']} & rowid={$productrow['raw_material_raw_material_id']}'><input type='button' name='edit' value='Edit' class='btn btn-primary' style='margin:2px'></a></td>";
                                    // echo "<td><a href='viewpurchase_return.php?delid={$productrow['purchase_return_purchasereturn_id']} & rowid={$productrow['raw_material_raw_material_id']}'><input type='button' name='edit' value='Delete' class='btn btn-danger' style='margin:2px'></a></td>";
                                    echo "</tr>";
                                }
                                    //echo "<td><a href='editpurchase_return.php?editid={$productrow['purchase_return_purchasereturn_id']} & rowid={$productrow['raw_material_raw_material_id']}'><input type='button' name='edit' value='Edit' class='btn btn-primary' style='margin:2px'></a></td>";
                                    //echo "</tr>";
                                ...
                                ?>
                                    ...
                                    <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">
                                        Insert
                                        Purchase return</h2>
                                    <form action="_handle_view_purchase_return.php" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                //    $sql="SELECT * FROM raw_material where raw_material_id in(select raw_material_raw_material_id from purchase_details where purchase_purchase_id='$pid')";
                                                   $sql = "SELECT * FROM `raw_material` WHERE `raw_material_id` in(SELECT `raw_material_raw_material_id` FROM `purchase_detail` WHERE `purchase_purchase_id` ='$id')";
...
$sql3=mysqli_query($conn,"select qty from purchase_detail where purchase_purchase_id='$id'");
...
?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button type="submit" name="add" class="btn btn-primary"> Insert
                                                    Purchase return</a>
                                                </button>
