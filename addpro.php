...
if ($_POST) {
    ...
    $proid = mysqli_fetch_array($id)[0] + 1;
    $product_name = mysqli_real_escape_string($conn, $_POST['product_name']);
    $price = mysqli_real_escape_string($conn, $_POST['price']);
    $product_qoh = mysqli_real_escape_string($conn, $_POST['qoh']);
      /* For path */
      ...
      {
        $img_path = "productimg/".$img ;  
      }
      $dir = 'C:\xampp\htdocs\machince&parts\productimg';
      $tmp = $_FILES['product_image']['tmp_name'];
      move_uploaded_file($tmp,"$dir\\$img");
      $category_id = mysqli_real_escape_string($conn, $_POST['category']);


    $q = mysqli_query($conn, "INSERT INTO `product` (`product_id`, `product_name`, `price`, `QOH`, `product_category_product_category_id`, `product_image`) VALUES ('$proid', '$product_name','$price', '$product_qoh', ' $category_id ',  '$img_path')") or die(mysqli_error($conn));
                ...
                <section class="forms-section">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                ...
                                <form method="post" enctype="multipart/form-data" data-parsley-validate=""
                                    ...
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Name
                                        </label>
                                        <div class="col-sm-10">
                                    ...
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Price
                                        </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="price" name="price"
                                                placeholder="Enter price" required autocomplete="off"
                                                data-parsley-trigger="keyup"
                                    ...
                                    <br>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Qoh</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="qoh" class="form-control" name="qoh"
                                                placeholder="Enter Product Quantity On Hand" required autocomplete="off"
                                                data-parsley-trigger="keyup"
                                    ...
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Image
                                        </label>
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" id="inputPassword3"
                                                name="product_image" placeholder="Product Image" required
                                    ...
                                    <select name="category" class="form-control" id="catid" required=""
                                        data-parsley-required-message="Select any category">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <button type="submit" name="submit" class="btn btn-primary"> Add Product
                                    </button>
                                    <button style="margin-left:2%" type="reset" class="btn btn-danger"> Reset</button>
                                    <button style="margin-left:2%" type="button"
                                        onclick="window.location='displayproduct.php'" class="btn btn-info"> View
                                    </button>
                                </div>
                            </div>
                            </form>
