...
<?php
$pid=$_GET['pid'] ;
 $q = mysqli_query($conn, "SELECT *from purchase where purchase_id='$pid'") or die(mysqli_error($conn));                               
while ($productrow = mysqli_fetch_array($q)) {
    $id=$productrow['supplier_supplier_id'];
      $date=$productrow['date'];
    

     $supname=mysqli_query($conn,"select supplier_name from supplier where supplier_id='$id'");
    ...
    <section class="home-section">
        ...
        //                                 }
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input readonly class="form-control" id="qty" name="qty"
                                                placeholder="Enter putchase id" required autocomplete="off"
                                ...
                                while ($productrow = mysqli_fetch_array($q)) {
                                   ...
                                   // echo "<td> $supname</td>";
                                    echo"<td> $ttprice </td>";
                                    echo "<td><a href='editpurchase.php?editid={$productrow['raw_material_raw_material_id']} & rowid={$productrow['raw_material_raw_material_id']}'><input type='button' name='edit' value='Edit' class='btn btn-primary' style='margin:2px'></a></td>";
                                    echo "</tr>";
                                }
                                ?>
                                                </tbody>
                            ...
                            <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC"> Insert
                                Purchase </h2>
                            <form action="_handle_view_purchase.php" method="POST" enctype="multipart/form-data"
