            ...
            <div id="content">
                <section class="tables-section">
                    <div class="outer-w3-agile mt-3">
                        <br>
                        <h2 class="tittle-w3-agileits mt-4 mb-3 text-center fs-1" style="color:#1F45FC">Product Category
                            Information
                        </h2>
                        <br>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $q = mysqli_query($conn, "SELECT * from product_category") or die(mysqli_error($conn));
                               ...
                               while ($userrow = mysqli_fetch_array($q))
                                {
                                    ...
                                    echo "<td>{$userrow['category_name']}</td>";
                                    echo "<tr>";
                        ...
                        <h5 class="tittle-w3-agileits mb-4">
                            <a href="addproductcat.php">
                                <button type="button" class="btn btn-primary" style="margin-left:70%">
                                    <b>Add Product Category Details</b>
                                </button>
                            </a>
                        </h5>
                    </div>
